...
//            'initialCaption'       => $this->initialCaption($this->value),
    ...
    public function destroy()
    {
        ...
        if ($this->storage->exists('small_' .$this->original)) {
            $this->storage->delete('small_' .$this->original);
        }
        if ($this->storage->exists('thn_' .$this->original)) {
            $this->storage->delete('thn_' .$this->original);
        }
    }
}