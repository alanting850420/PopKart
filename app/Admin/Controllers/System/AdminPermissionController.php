...
class AdminPermissionController extends Controller
{
    ...
    {
        return Admin::grid(AdminPermission::class, function (Grid $grid) {
    ...
    {
        return Admin::form(AdminPermission::class, function (Form $form) {
    ...
    {
        return array_combine(AdminPermission::$httpMethods, AdminPermission::$httpMethods);
    }
}
