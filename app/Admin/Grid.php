...
use Closure;
use App\Admin\Exception\Handler;
...
class Grid
{
    ...
    public static function registerColumnDisplayer()
    {
        $map = [
            ...
            'switchGroup' => \App\Admin\Grid\Displayers\SwitchGroup::class,
            'select'      => \App\Admin\Grid\Displayers\Select::class,
            'image'       => \App\Admin\Grid\Displayers\Image::class,
            'label'       => \App\Admin\Grid\Displayers\Label::class,
            'button'      => \App\Admin\Grid\Displayers\Button::class,
            'link'        => \App\Admin\Grid\Displayers\Link::class,
            'badge'       => \App\Admin\Grid\Displayers\Badge::class,
            'progressBar' => \App\Admin\Grid\Displayers\ProgressBar::class,
            'radio'       => \App\Admin\Grid\Displayers\Radio::class,
            'checkbox'    => \App\Admin\Grid\Displayers\Checkbox::class,
            'orderable'   => \App\Admin\Grid\Displayers\Orderable::class,
            'openMap'   => \App\Admin\Grid\Displayers\OpenMap::class,
        ];
