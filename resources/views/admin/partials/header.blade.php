...
<header class="main-header">
    ...
    <a href="{{ admin_base_path('/') }}" class="logo">
        ...
        <span class="logo-mini" style="font-family: 'Microsoft YaHei'">{!! config('admin.logo-mini', config('admin.name')) !!}</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg" style="font-family: 'Microsoft YaHei'">{!! config('admin.logo', config('admin.name')) !!}</span>
    </a>
